...
class Database:
    ...
    async def _create_indexes(self):
        ...
        Indexes are created based on the schema design:
        - sensor_readings: room_name + sensor_type + timestamp
        - rooms: unique name index
        - calendar_events: room_name + time range
        """
        try:
            ...
            await calendar_collection.create_index(
                [("event_id", 1)],
                unique=True,
                sparse=True,  # Allow documents without event_id
